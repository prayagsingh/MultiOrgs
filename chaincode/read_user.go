...
func (t *SimpleChaincode) readUser(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	...
	if err != nil {
		return shim.Error(fmt.Sprintf("Unable to create the composite Key: %v", err))
	}
...
func (t *SimpleChaincode) readAllUser(stub shim.ChaincodeStubInterface, args []string) pb.Response {
